...
function SectionPedidos() {
    ...
    function gerarTags() {
        ...
        //const [quantidadeDeItensSelecionadoss, setQuantidadeDeItensSelecionados] = useState()
        ...
        function incrementar(itemName: string) {
            quantidadeDeItensSelecionados[itemName] = quantidadeDeItensSelecionados[itemName] + 1;
        }
                    ...
                    sections.push(
                        <section className={styles.sectionParaCadaItem}>
                            ...
                            <div className={styles.incrementarOuDecrementar}>
                                ...
                                <button className={styles.incrementar}>+</button>
                            </div>
                        </section>
                    );
                    break;      
                ...
                case 'tortaDeMaca':
                    sections.push(
                        <section className={styles.sectionParaCadaItem}>
                            <img src={tortaDeMaca} />
                            <div className={styles.divParaInformacoes}>
                                <h3 className={styles.nomeDoItem}>Torta de Maça</h3>
                                <h4 className={styles.valorDoItem}>R$5,00</h4>
                            </div>
                            <div className={styles.incrementarOuDecrementar}>
                                <button className={styles.decrementar}>-</button>
